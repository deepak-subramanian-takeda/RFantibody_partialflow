...
# run_beam_denovo.sh
#
# Runs beam_denovo_maturation.py on a remote server and keeps it alive
# after you disconnect using nohup + output logging.
#
# Usage:
#   bash run_beam_denovo.sh          # start the job
#   bash run_beam_denovo.sh status   # check if running
#   bash run_beam_denovo.sh log      # tail the live log
#   bash run_beam_denovo.sh stop     # kill the job
...
start() {
    ...
    echo "[start] Launching beam search de novo maturation..."
